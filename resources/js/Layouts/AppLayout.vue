...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('dashboard.post.index')" :active="route().current('dashboard.post.index')">
                                    Post
                                </NavLink>

                                <NavLink :href="route('dashboard.product.index')" :active="route().current('dashboard.product.index')">
                                    Product
                                </NavLink>

                                <NavLink :href="route('dashboard.category.index')" :active="route().current('dashboard.category.index')">
                                    Category
                                </NavLink>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div class="relative ml-3">
                                <!-- Teams Dropdown -->
                                <Dropdown v-if="$page.props.jetstream.hasTeamFeatures && $page.props.user.current_team" align="right" width="60">
                                    <template #trigger>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('dashboard.post.index')" :active="route().current('dashboard.post.index')">
                            Post
                        </ResponsiveNavLink>

                        <ResponsiveNavLink :href="route('dashboard.product.index')" :active="route().current('dashboard.product.index')">
                            Product
                        </ResponsiveNavLink>
            ...
            <!-- Page Heading -->
            <header v-if="$slots.header" class="sticky top-0 z-10 bg-white shadow">
