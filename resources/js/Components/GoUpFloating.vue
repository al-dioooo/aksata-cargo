...
<template>
    <div class="fixed inset-0 flex items-end p-8 pointer-events-none">
        <button @click="scrollTop" class="p-2 text-xs text-white bg-blue-400 rounded-full pointer-events-auto">
